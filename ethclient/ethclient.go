...
func (ec *Client) CallContract(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int) ([]byte, error) {
	// ec = Dial("/home/thach/.ethereum/geth.ipc")
...
// CallCheckMinerContract to be called on blockvalidator
func (ec *Client) CallCheckMinerContract(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int) (*big.Int, error) {
	// ec = Dial("/home/thach/.ethereum/geth.ipc")
	var hex hexutil.Big
	err := ec.c.CallContext(ctx, &hex, "eth_call", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
